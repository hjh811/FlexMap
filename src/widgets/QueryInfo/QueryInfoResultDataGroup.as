...
public class QueryInfoResultDataGroup extends DataGroup
{
    public function QueryInfoResultDataGroup()
    {
        super();

        this.itemRenderer = new ClassFactory(PDAResultItemRenderer);
    }
}
